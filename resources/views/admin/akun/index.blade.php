...
<body>
    ...
    <td>
        @if($user->usertype == 'siswa')
        <form onsubmit="return confirm('Jika Akun Saya Dihapus Maka Data Siswa Akan Ikut Terhapus, Apakah Anda Yakin ?');" action="{{ route('akun.destroy', $user->id) }}" method="POST">
            @else
